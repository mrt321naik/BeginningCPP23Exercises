// Ex5_07.cpp - Generating multiplication tables using nested loops
#include<iostream>
#include<print>
...
int main() 
{
  ...
  const int table_min {2}; // Minimum table size - at lease up to the 2-times
  const int table_max {12}; // Maximum table size
  char reply {};            // Response to prompt


  do {
    std::print("What size table would u like ({} to {})?", table_min, table_max);
