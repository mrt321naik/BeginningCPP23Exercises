// Eg8_15.cpp - Overloading a function with reference paramenters
#include<iostream>
#include<print>
...
int main() 
{
  ...
  std::println("The larger of int values {} and {} is {}", a_int, b_int, larger(static_cast<long>(a_int), static_cast<long>(b_int)));
}
...
// Returns the larger of two long refernces
