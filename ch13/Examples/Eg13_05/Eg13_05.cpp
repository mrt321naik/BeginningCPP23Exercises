// Ex13_05.cpp - Using the addition operator for Box objects
import std;
import box;
...
int main() 
{
  ...
  std::println("The two boxes that sum to the smallest volume are {} and {}", to_string(boxes[first]), to_string(boxes[second]));
